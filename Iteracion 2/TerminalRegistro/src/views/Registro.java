...
public class Registro extends JFrame implements IVistaRegistro {
    ...
    private IControladorRegistro controlador;
    ...
    public void setController(IControladorRegistro c){
        this.controlador = c;
        setActionListeners();
    ...
    private void setActionListeners(){
        this.btnRegistrar.addActionListener(e -> controlador.registrarTurno());
    }
