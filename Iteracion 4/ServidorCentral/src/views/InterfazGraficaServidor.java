...
public class InterfazGraficaServidor extends JFrame implements IVistaServidor{
    ...
    // -------------------
    /*
    private void actualizar(List<Turno> listaTurnos,
...
//        // Título
	...
	public void actualizarTurnosVistaServidor(List<Turno> turnos) {
        SwingUtilities.invokeLater(() -> {
    		System.out.println("ANTES borrar filas="
    	            + modeloTabla.getRowCount());
            modeloTabla.setRowCount(0);
    	    System.out.println("DESPUES borrar filas="
    	            + modeloTabla.getRowCount());
	...
	public void actualizarTerminalesVistaServidor(List<String> terminalesRegistro, List<String> terminalesAtencion,
        ...
        actualizarLista(modeloRegistro, terminalesRegistro);
        actualizarLista(modeloAtencion, terminalesAtencion);
        actualizarLista(modeloNotificacion, terminalesNotificacion);
